...
namespace Magento\CustomerMessageBroker\Model;

use Magento\CustomerMessageBroker\Adapter\Rest\Client;
use Magento\CustomerMessageBroker\Model\Data\CustomerTransformer;
...
class CustomerRepositoryWrapper
{
    ...
    public function getById(int $customerId): array
    {
        ...
        if (200 == $response['status']) {
            ...
            throw new NoSuchEntityException(__('No such entity with customerId = %1', $customerId));
        } else {
